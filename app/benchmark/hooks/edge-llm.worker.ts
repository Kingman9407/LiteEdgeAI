...
async function loadModel(modelId?: string) {
  ...
  // Multi-threading works by serving ort.bundle.min.mjs from /public (HTTP)
  ...
  // Point ORT's thread worker spawner at our HTTP-served copy of ort.bundle.min.mjs.
  // Without this, ORT resolves to node_modules via file:// which browsers block.
  ort.env.wasm.workerURL = `${self.location.origin}/ort.bundle.min.mjs`;
  // Note: ort.env.wasm.simd is deprecated in ORT 1.20.1 and ignored — omitting to suppress the warning
