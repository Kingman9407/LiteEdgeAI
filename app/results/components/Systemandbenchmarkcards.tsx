import type {
    ...
    BenchmarkResults,
    GPUInfo
} from './types'; // Changed: Update import path to './types' instead of '../components/types'
...
export function SystemAndBenchmarkCards({
    ...
    return (
        <div className="grid md:grid-cols-2 gap-6">
            ...
            <div
                className="rounded-xl bg-black/80 backdrop-blur p-6
                        ...
                        <div className="rounded-lg bg-emerald-500/5 border border-emerald-500/10 p-3">
                            ...
                            <div className="space-y-2 max-h-96 overflow-y-auto">
                                {benchmarkResults.benchmarks.map((bench, i) => (
                                    <div key={i} className="rounded bg-black/30 border border-emerald-500/10 p-3">
                                        <div className="flex items-center justify-between mb-2">
                                            <span className="text-white font-medium text-sm">{bench.name}</span>
                                        ...
                                        <div className="grid grid-cols-3 gap-2 text-xs">
                                            <div>
                                                ...
                                                <div className="text-white font-mono">{bench.totalTime.toFixed(2)}s</div>
                                            </div>
                                            <div>
                                                <div className="text-gray-500">Tokens</div>
                                                <div className="text-white font-mono">{bench.tokenCount}</div>
                                            </div>
                                            <div>
                                                <div className="text-gray-500">Words</div>
                                                <div className="text-white font-mono">{bench.wordCount}</div>
                                            </div>
                                        </div>
                                    </div>
                                ))}
